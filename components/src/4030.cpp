...
CMP4030::CMP4030(std::string name)
{
        ...
        _pin_func[1] = std::bind(&CMP4030::inputPin, this, std::placeholders::_1);
        _pin_func[2] = std::bind(&CMP4030::inputPin, this, std::placeholders::_1);
        _pin_func[5] = std::bind(&CMP4030::inputPin, this, std::placeholders::_1);
        _pin_func[6] = std::bind(&CMP4030::inputPin, this, std::placeholders::_1);
        _pin_func[8] = std::bind(&CMP4030::inputPin, this, std::placeholders::_1);
        _pin_func[9] = std::bind(&CMP4030::inputPin, this, std::placeholders::_1);
        _pin_func[12] = std::bind(&CMP4030::inputPin, this, std::placeholders::_1);
        _pin_func[13] = std::bind(&CMP4030::inputPin, this, std::placeholders::_1);

        _pin_func[3] = std::bind(&CMP4030::outputPin, this, std::placeholders::_1);
        _pin_func[4] = std::bind(&CMP4030::outputPin, this, std::placeholders::_1);
        _pin_func[10] = std::bind(&CMP4030::outputPin, this, std::placeholders::_1);
        _pin_func[11] = std::bind(&CMP4030::outputPin, this, std::placeholders::_1);
...
std::string CMP4030::getName() const
{
        return _name;
}

void CMP4030::setLink(std::size_t pin, nts::IComponent &other, std::size_t otherPin)
{
...
nts::Tristate CMP4030::compute(std::size_t pin)
{
...
nts::Tristate CMP4030::inputPin(std::size_t pin)
{
        if (_links[pin].first) {
...
nts::Tristate CMP4030::outputPin(std::size_t pin)
{
...
nts::Tristate CMP4030::andCompute(std::size_t a, std::size_t b) const
{
